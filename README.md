# 🚀 Muhammad Ahmad Iqbal — Frontend Developer Portfolio

A modern, responsive portfolio website built with React, Vite, and Tailwind CSS. Showcasing my skills as a frontend developer with interactive design, smooth animations, and a clean professional layout.
...
- **Project Showcase** → Completed projects with technologies
...
- **Education** → BSCS at KFUEIT (2024-2028)
- **Experience** → Trainee Frontend Developer at Promoteez International
- **Projects** → Showcase of completed projects
- **Contact** → WhatsApp, GitHub, Email
